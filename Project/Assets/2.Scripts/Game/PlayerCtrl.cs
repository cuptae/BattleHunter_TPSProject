...
public class PlayerCtrl : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        Vector3 lookForward = new Vector3(camera.transform.forward.x,0,camera.transform.forward.z).normalized;
        Vector3 lookSide = new Vector3(camera.transform.right.x,0,camera.transform.right.z).normalized;
